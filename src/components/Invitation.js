...
import groom from '../images/Inder1.jpg'
import bride from '../images/Manjula1.jpg'
            ...
            <div className="couple-wrap">
              <div className="couple-half">
                ...
                <div className="desc-bride">
                  <h3>Manjula Jadhav</h3>
                  <h5>D/O Devinder R. Jadhav</h5>
                  <h5>Rekha Jadhav</h5>
                </div>
              </div>
              ...
              <div className="couple-half">
                ...
                <div className="desc-groom">
                  <h3>Inder Singh Patliya</h3>
                  <h5>S/O Lal Singh Patliya</h5>
                  <h5>Mamta Patliya</h5>
                </div>
              </div>
            </div>
